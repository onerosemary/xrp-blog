<template>
    <section class="container f-t">
        ...
        <div class="input-group">
            <input type="text" class="form-control" v-model="keyword" placeholder="全站搜索" >
            <div class="input-group-append">
                <button class="btn btn-outline-secondary" type="button" id="button-addon2" @click="searchKeyword">搜索</button>
            </div>
        </div>
...
export default {
  ...
  watchQuery: ['keyword','page', 'size'],

  async asyncData(ctx) {
   const data = {
     keyword: ctx.route.query.keyword, // 关键词
     page: ctx.route.query.page,
     size: ctx.route.query.size,
   }
   const articleListData =  await searchList(data)
   ...
   return { 
     ...
     pageSize: size,
     totals: total,
     keyword: ctx.route.query.keyword
    }
  },
  methods: {
